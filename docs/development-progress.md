...
- 2026-09-19: Rebuilt the customer login screen as a responsive marketplace entry page with Nivasa positioning, local-shopping benefits, community delivery messaging, marketplace showcase cards, and the existing mobile OTP flow.
